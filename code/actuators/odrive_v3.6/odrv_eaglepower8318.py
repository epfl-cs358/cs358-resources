...
odrv0.axis1.motor.config.current_lim = 58 # max continuous current
odrv0.axis1.motor.config.calibration_current = 29
odrv0.axis1.config.calibration_lockin.current = 29
...
odrv0.axis1.controller.config.vel_gain = 0.4  # default 0.16666666
