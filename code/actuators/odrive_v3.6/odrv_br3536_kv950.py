...
odrv0.axis1.motor.config.torque_constant = 8.27 / 950
...
odrv0.axis1.config.calibration_lockin.current = 15
...
odrv0.axis1.motor.config.phase_inductance = 5.632489319395972e-06 
odrv0.axis1.motor.config.phase_resistance = 0.033803995698690414
