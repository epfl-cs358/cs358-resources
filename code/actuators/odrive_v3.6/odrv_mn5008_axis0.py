...
odrv0.axis0.motor.config.current_lim = 15 # max continuous current
odrv0.axis0.motor.config.calibration_current = 8
odrv0.axis0.config.calibration_lockin.current = 8
...
odrv0.axis0.controller.config.vel_gain = 0.08  # default 0.16666666
odrv0.axis0.controller.config.pos_gain = 50  # default 20
